...
_models = {
    'arcface_r100_v1': arcface_r100_v1.prepare(ctx_id=1, nms=0.7),
    'retinaface_r50_v1': retinaface_r50_v1.prepare(ctx_id=1, nms=0.7),
    'retinaface_mnet025_v1': retinaface_mnet025_v1.prepare(ctx_id=1, nms=0.7),
    'retinaface_mnet025_v2': retinaface_mnet025_v2.prepare(ctx_id=1, nms=0.7),
    'genderage_v1': genderage_v1.prepare(ctx_id=1, nms=0.7),
}
